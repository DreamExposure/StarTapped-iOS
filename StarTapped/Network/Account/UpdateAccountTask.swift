                ...
                .responseJSON { response in
                    ...
                    case .success(_):
                        if response.result.value != nil {
                            ...
                            let status = NetworkCallStatus(failure: false, success: true, type: TaskType.ACCOUNT_UPDATE).setCode(code: code).setBody(body: json).setMessage(message: json["message"].stringValue)
