...
class GetBlogViewTask: NetworkTask {
                ...
                .responseJSON { response in
                    ...
                    case .success(_):
                        if response.result.value != nil {
                            ...
                            let status = NetworkCallStatus(failure: false, success: true, type: TaskType.BLOG_GET_VIEW).setCode(code: code).setBody(body: json).setMessage(message: json["message"].stringValue)
                    ...
                    case .failure(_):
                        ...
                        let status = NetworkCallStatus(failure: true, success: false, type: TaskType.BLOG_GET_VIEW)
